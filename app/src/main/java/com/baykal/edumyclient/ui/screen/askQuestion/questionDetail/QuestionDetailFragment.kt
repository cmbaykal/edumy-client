package com.baykal.edumyclient.ui.screen.askQuestion.questionDetail
...
@AndroidEntryPoint
class QuestionDetailFragment : BaseFragment() {

    override val viewModel: ViewModel by viewModels<QuestionDetailViewModel>()
